            ...
            <div class="col-12">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input name="jenis_servis" type="text" class="form-control @error('jenis_servis') is-invalid @enderror" placeholder="Masukkan judul berita" value="{{ old('jenis_servis') }}">
                        </div>
                        @error('jenis_servis')
                        <span class="invalid-feedback alert-danger" role="alert">
                            {{ $message }}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <select class="form-control form-select @error ('kategories_id') is-invalid @enderror" name="kategories_id" id="floatingSelect" aria-label="Floating label select example">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <textarea name="detail" rows="3" class="form-control @error('detail') is-invalid @enderror" id="ckeditor" placeholder="Masukkan detail customer" value="{{ old('detail') }}"></textarea>
                            @error('detail')
                            <span class=" invalid-feedback alert-danger" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <div class="text-start">
                                <a href="{{ route('berita.index') }}"><button type="button" class="btn btn-ghost-danger active w-17"><i class="fa fa-arrow-left"></i> &nbsp; Kembali</button>
                            </div>
                            <div class="text-end">
