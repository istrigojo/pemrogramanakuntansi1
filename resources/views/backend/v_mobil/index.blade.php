...
@section('content')
    ...
    <div class="table-responsive">
                ...
                @foreach ($mobil as $index => $row)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('mobil.destroy', $row->id) }}"
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary"> Showing <span> {{ $mobil->firstItem() }} </span> to <span>
                    {{ $mobil->lastItem() }} </span> of <span> {{ $mobil->total() }} </span> entries</p>
