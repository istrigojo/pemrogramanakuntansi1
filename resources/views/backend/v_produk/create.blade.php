        ...
        <form action="{{ route('produk.store') }}" method="post" class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <textarea name="detail" id="detail" class="form-control @error('detail') is-invalid @enderror" placeholder="Masukkan detail produk" value="{{ old('nama_produk') }}"></textarea>
                    </div>
                    @error('detail')
                    <span class=" invalid-feedback alert-danger" role="alert">
                        {{ $message }}
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label">Tanggal Masuk</label>
                    <div class="col">
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label">Tanggal Keluar</label>
                    <div class="col">
