        ...
        <div class="card">
            <form action="{{ route('produk.store') }}" method="post" class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <textarea name="detail" id="detail" class="form-control @error('detail') is-invalid @enderror"
                                placeholder="Masukkan detail produk" value="{{ old('nama_produk') }}"></textarea>
                        </div>
                        @error('detail')
                            <span class=" invalid-feedback alert-danger" role="alert">
                                {{ $message }}
                    ...
                    <div class="mb-3 row">
                        <label class="col-2 col-form-label required">Merk</label>
                        <div class="col">
                    ...
                    <div class="mb-3 row">
                        <label class="col-2 col-form-label required">Harga</label>
                        <div class="col">
                            <input name="harga" type="text" class="form-control @error('harga') is-invalid @enderror"
                                placeholder="Masukkan Harga Barang" value="{{ old('harga') }}">
                            <!-- <small class="form-hint">We'll never share your email with anyone else.</small> -->
                        </div>
                        @error('harga')
                            <span class="invalid-feedback alert-danger" role="alert">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input name="tanggal_masuk" type="date"
                                ...
                                placeholder="Masukkan tanggal_masuk Barang" value="{{ old('tanggal_masuk') }}">
                            <!-- <small class="form-hint">We'll never share your email with anyone else.</small> -->
                        </div>
                        @error('tanggal_masuk')
                            <span class="invalid-feedback alert-danger" role="alert">
