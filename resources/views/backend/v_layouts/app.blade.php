      ...
      <header class="navbar navbar-expand-md d-print-none">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('home') }}">
              <img src="{{ asset('backend/static/Logonobg.svg') }}" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <span class="avatar avatar-sm" style="background-image: url(backend/static/avatars/ppme.png)"></span>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                <!-- Nav Item 1 -->
                <li class="{{ (strpos(Route::currentRouteName(), 'home') !== false) ? 'nav-item active' : 'nav-item' }}">
                ...
                <li class="nav-item dropdown {{ (strpos(Route::currentRouteName(), 'berita') !== false || strpos(Route::currentRouteName(), 'kategories') !== false) ? 'active' : '' }}">
                ...
                <li class="nav-item dropdown {{ (strpos(Route::currentRouteName(), 'mobil') !== false || strpos(Route::currentRouteName(), 'customer') !== false) ? 'active' : '' }}">
                  <a class=" nav-link dropdown-toggle" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item dropdown {{ (strpos(Route::currentRouteName(), 'montir') !== false || strpos(Route::currentRouteName(), 'kategori') !== false || strpos(Route::currentRouteName(), 'bagkategori') !== false ) ? 'active' : '' }}">
                  <style>
                    .dropdown-item svg {
                      margin-right: 8px;
                ...
                <li class="{{ (strpos(Route::currentRouteName(), 'produk') !== false) ? 'nav-item active' : 'nav-item' }}">
                ...
                <li class="nav-item dropdown {{ (strpos(Route::currentRouteName(), 'servis') !== false || strpos(Route::currentRouteName(), 'akun') !== false || strpos(Route::currentRouteName(), 'servis') !== false) ? 'active' : '' }}">
                  <a class="nav-link dropdown-toggle" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-transaction-dollar" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
