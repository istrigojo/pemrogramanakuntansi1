        ...
        <form action="{{ route('user.store') }}" method="post" enctype="multipart/form-data" class="card">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input name="foto" type="file" class="form-control @error('foto') is-invalid @enderror" onchange="previewFoto()" value="{{ old('foto') }}">
                        <small class="form-hint">Pilih file foto user max. 1 mb. Format: jpeg, jpg, png, gif. </small>
                    </div>
                    @error('foto')
                ...
                <div class="mb-3 row form-floating">
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <select class="form-control form-select @error('akses') is invalid @enderror" name="akses" id="floatingSelect" aria-label="Floating label select example">
                                <option value="" {{ old('akses') == '' ? 'selected' : '' }}> --Pilih Hak Akses-- </option>
                                <option value="1" {{ old('akses') == '1' ? 'selected' : '' }}>Super Admin</option>
                                <option value="2" {{ old('akses') == '2' ? 'selected' : '' }}>Administrator</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="Masukkan nama lengkap" value="{{ old('nama') }}">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input name="no_hp" type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('no_hp') is-invalid @enderror" placeholder="Masukkan nomor telephone" value="{{ old('no_hp') }}">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        ...
                        <small class="form-hint">Password harus terjadi dari huruf kecil (a-z), huruf besar (A-Z), angka (1,2,3) dan simbol karakter (?=.*[\W_]).</small>
                    </div>
                    @error('password')
                    <span class="invalid-feedback alert-danger" role="alert">
                        {{ $message }}
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input name="password_confirmation" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="**********">
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between">
                    <div class="text-start">
                        <a href="{{ route('user.index') }}"><button type="button" class="btn btn-ghost-danger active w-17"> <i class="fa fa-arrow-left"></i> &nbsp; Kembali</button>
                    </div>
                    <div class="text-end">
